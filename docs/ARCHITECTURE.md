...
* `README.md`
  * **Role:** Overall information about the project.
  * **Content:** Information about the project and help on how to setup.
...
* cache:
  * **Role:** `ingest_news.py` creates a file which allows for faster ingestion.
  * **Content:** `.json` file which contains the news and headlines for each match.
